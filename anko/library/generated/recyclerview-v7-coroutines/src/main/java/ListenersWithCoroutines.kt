...
class __RecyclerView_OnChildAttachStateChangeListener(private val context: CoroutineContext) : RecyclerView.OnChildAttachStateChangeListener {
...
class __RecyclerView_OnItemTouchListener(private val context: CoroutineContext) : RecyclerView.OnItemTouchListener {

    private var _onInterceptTouchEvent: (suspend CoroutineScope.(RecyclerView, android.view.MotionEvent) -> Boolean)? = null
    ...
    fun onInterceptTouchEvent(
            ...
            listener: suspend CoroutineScope.(RecyclerView, android.view.MotionEvent) -> Boolean
    ) {
        _onInterceptTouchEvent = listener
        _onInterceptTouchEvent_returnValue = returnValue
    }

    private var _onTouchEvent: (suspend CoroutineScope.(RecyclerView, android.view.MotionEvent) -> Unit)? = null
    ...
    fun onTouchEvent(
            listener: suspend CoroutineScope.(RecyclerView?, android.view.MotionEvent?) -> Unit
    ) {
