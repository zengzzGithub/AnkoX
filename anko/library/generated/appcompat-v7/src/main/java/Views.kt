...
internal object `$$Anko$Factories$AppcompatV7View` {
    ...
    val TINTED_AUTO_COMPLETE_TEXT_VIEW = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatAutoCompleteTextView(ctx) else AutoCompleteTextView(ctx) }
    val TINTED_BUTTON = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatButton(ctx) else Button(ctx) }
    val TINTED_CHECK_BOX = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatCheckBox(ctx) else CheckBox(ctx) }
    val TINTED_CHECKED_TEXT_VIEW = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatCheckedTextView(ctx) else CheckedTextView(ctx) }
    val TINTED_EDIT_TEXT = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatEditText(ctx) else EditText(ctx) }
    val TINTED_IMAGE_BUTTON = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatImageButton(ctx) else ImageButton(ctx) }
    val TINTED_IMAGE_VIEW = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatImageView(ctx) else ImageView(ctx) }
    val TINTED_MULTI_AUTO_COMPLETE_TEXT_VIEW = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatMultiAutoCompleteTextView(ctx) else MultiAutoCompleteTextView(ctx) }
    val TINTED_RADIO_BUTTON = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatRadioButton(ctx) else RadioButton(ctx) }
    val TINTED_RATING_BAR = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatRatingBar(ctx) else RatingBar(ctx) }
    val TINTED_SEEK_BAR = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatSeekBar(ctx) else SeekBar(ctx) }
    val TINTED_SPINNER = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatSpinner(ctx) else Spinner(ctx) }
    val TINTED_TEXT_VIEW = { ctx: Context -> if (Build.VERSION.SDK_INT < 21) androidx.appcompat.widget.AppCompatTextView(ctx) else TextView(ctx) }
